  ...
  <div class="w-11/12 md:w-4/5 mx-auto p-5" v-if="fixDetail">
    ...
    <div v-if="tab_id === 'B'">
      ...
      >
        <div id="possession" class="mb-4">
          ...
          <div class="flex">
            <progress
              class="w-full rotate-180 h-2 bg-green-400 mr-1"
            ...
            ></progress>
            <progress
              class="w-full bg-rose-400 ml-1 h-2"
        ...
        <div id="goal_attempts" class="mb-4">
          ...
          <div class="flex">
            <progress
              class="w-full rotate-180 h-2 bg-green-400 mr-1 rounded"
            ...
            ></progress>
            <progress
              class="w-full bg-rose-400 ml-1 h-2 rounded"
    ...
    <div v-if="tab_id === 'C'">
      <div class="football-field">
        ...
        <div class="flex justify-evenly mb-4">
          <div class="bg-green-400 w-5">jjf</div>
          <div class="bg-rose-400 w-5">jjf</div>
          <div class="bg-yellow-400 w-5">jjf</div>
